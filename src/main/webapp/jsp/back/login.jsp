...
<head>
            ...
            $.ajax({
                ...
                success:function (data) {
                    if (data!=null&data!=""){
                        ...
                        location.href = "${pageContext.request.contextPath}/jsp/back/main.jsp";
                    }
                }
    ...
    <script>
        function changeCaptcha() {
            ...
            img.src='${pageContext.request.contextPath}/admin/code?number='+Math.random();
        }
    </script>
</head>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body" id = "model-body">
            ...
            <div class="form-group">
                ...
                <img id="img" class="img-rounded " src="${pageContext.request.contextPath}/admin/code">&nbsp;
                <button class="btn btn-default " type="button" onclick="changeCaptcha()">更换</button>
